...
-- DropForeignKey
ALTER TABLE "clinician" DROP CONSTRAINT "clinician_userId_fkey";

-- DropForeignKey
ALTER TABLE "session" DROP CONSTRAINT "session_userId_fkey";

-- DropIndex
DROP INDEX "clinician_userId_key";
...
-- AddForeignKey
ALTER TABLE "clinician" ADD CONSTRAINT "clinician_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("_id") ON DELETE CASCADE ON UPDATE CASCADE;
